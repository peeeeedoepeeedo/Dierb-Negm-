import { readProductsPage } from "@/lib/mobile-api/catalog";
...
export async function GET(request: Request) {
  return withMobileApi(request, async () => {
    ...
    const result = await readProductsPage({
      ...
      query: optionalText(params, "q", 100), storeId: optionalText(params, "storeId", 128),
      categoryId: optionalText(params, "categoryId", 128), locationId: optionalText(params, "locationId", 128),
    });
